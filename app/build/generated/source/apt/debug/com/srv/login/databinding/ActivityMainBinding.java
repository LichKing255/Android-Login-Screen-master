package com.srv.login.databinding;
import com.srv.login.R;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @NonNull
    public final com.srv.login.login.LoginButton button;
    @NonNull
    ...
    @NonNull
    public final com.srv.login.FlexibleFrameLayout wrapper;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.button = (com.srv.login.login.LoginButton) bindings[3];
        ...
        this.wrapper = (com.srv.login.FlexibleFrameLayout) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.srv.login.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.srv.login.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
